...
export class PuppeteerService {
  ...
  async play() {
    (async () => {
      ...
      await page.waitForSelector(".signin__button")
      await page.click(".signin__button");
      ...
      await page.waitForSelector(".sign__buttons button:nth-child(2)");
      await page.click(".sign__buttons button:nth-child(2)");
      await browser.close();
